...
function buildImageGenerationPrompt(prompt, sectionId, imageName, refImageNames = [], taskType = "section") {
  ...
  return [
    ...
    "Base the composition on the mobile version's information design: keep the same content hierarchy, spacing rhythm, icon/illustration style, and reading flow as the mobile section. Do not simply stretch or scale up the mobile layout sideways into a shallow banner.",
    "Do not force a fixed aspect ratio like 16:9. Let the section's own content decide a natural height for a 1200px-wide frame (this can still be closer to portrait/square for text- or list-heavy sections, and only wider when the content genuinely spreads out well, e.g. side-by-side comparisons).",
    "The result should feel like a natural, well-proportioned desktop evolution of the mobile design, not a different layout language.",
