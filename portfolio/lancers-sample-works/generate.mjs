...
const targets = [
  { promptFile: "prompt-banner.md", sectionId: "lancers-sample-banner", imageName: "banner.png" },
  { promptFile: "prompt-before-after.md", sectionId: "lancers-sample-before-after", imageName: "before-after.png" },
];
