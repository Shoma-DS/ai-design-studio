...
const projectRoot = path.join(repoRoot, "portfolio/lumiere-nail-atelier-swipe-lp");
...
const sections = [
  ...
  { id: "02-portfolio-1", imageName: "02-portfolio-1.png" },
  { id: "03-portfolio-2", imageName: "03-portfolio-2.png" },
