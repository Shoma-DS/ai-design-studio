...
ページ高 6493px（7.7画面分） / テキストブロック 81 / 操作要素 8 / 画像 5
...
- `div.menu-list > article > div > p.menu-no` — 12.0px "一"
- `div.menu-list > article > div > p` — 14.0px "澄んだ旨みと、柚子の香り。"
- `div.menu-list > article > div > p.menu-no` — 12.0px "二"
...
### 🔵 参考 [反復] 余白の47%が4pxグリッドから外れている（8pxグリッドに寄せると整列と反復が効く）
...
- `main#top > section.story.reveal > p.section-label` — marginBottom: 38.0px
...
ページ高 6280px（7.0画面分） / テキストブロック 84 / 操作要素 11 / 画像 5
...
- `body > header.site-header > a.brand > small` — 12.0px "貝だし麺処"
- `main#top > section.hero > div.hero-copy > p.kicker` — 12.0px "SHELLFISH BROTH RAMEN"
- `main#top > section.hero > p.hero-note` — 12.0px "ゆっくり炊いて、すっきり仕上げる。"
- `div.menu-list > article > div > p.menu-no` — 12.0px "一"
- `div.menu-list > article > div > p.menu-no` — 12.0px "二"
- `div.menu-list > article > div > p.menu-no` — 12.0px "三"
